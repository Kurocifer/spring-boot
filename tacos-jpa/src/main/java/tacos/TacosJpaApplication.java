...
public class TacosJpaApplication {
	...
	/*
	 * @Bean public CommandLineRunner dataLoader(IngredientRepository repo) { return
	 * new CommandLineRunner() {
	 * 
	 * @Override public void run(String... args) throws Exception { repo.save(new
	 * Ingredient("FLTO", "Flour Tortilla", Type.WRAP)); repo.save(new
	 * Ingredient("COTO", "Corn Tortilla", Type.WRAP)); repo.save(new
